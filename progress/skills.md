...
> Проценты появятся после диагностики и будут отражать наблюдаемые результаты, а не количество проведённых уроков.
...
- 📞 Phone calls and messages: не оценён
...
| 2026-09-16 | Writing / Grammar | `nie mam wodę` → после объяснения самостоятельно `nie mamy gorącej wody` | Первые данные по dopełniacz после отрицания; +5 XP за самостоятельное исправление |
